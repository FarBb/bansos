...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Data Siswa Hasil Klasifikasi</h1>
  <p class="mb-4">Data Hasil Klasifikasi Adalah Data Yang Sudah Terklasifikasi.
  </p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <a href="<?= base_url('admin/data_testing.php') ?>" class="btn btn-primary btn-icon-split">
        <span class="icon text-white-50">
          <i class="fas fa-plus"></i>
        </span>
        <span class="text">Tambah Data</span>
      </a>
      <a href="<?= base_url('laporan/cetak.php') ?>" class="btn btn-warning btn-icon-split">
        <span class="icon text-white-50">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            foreach ($data as $b) : ?>
              ...
              <?php
              if ($b['keterangan'] == 'Mendapatkan Bantuan') {
              ...
              <tr>
                ...
                <td><?= $ket ?></td>
                <td>
                  <button type="button" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#exampleModal<?= $b['nis'] ?>">
                    <i class="fas fa-eye"></i>
                  </button>
                  <a class="btn btn-danger btn-sm" href="proses_hapus_data_klasifikasi.php?nis=<?= $b["nis"]; ?>" onclick="return confirm('Apakah Anda Ingin Menghapus Data Hasil Klasifikasi Siswa?');">
              ...
              <!-- Modal -->
              <div class="modal fade" id="exampleModal<?= $b['nis'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
